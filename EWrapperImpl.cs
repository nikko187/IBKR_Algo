    ...
    //! [ewrapperimpl]
        ...
        public virtual void error(int id, int errorCode, string errorMsg, string advancedOrderRejectJson)
        {
            ...
            else
            {
                ...
                form1.Error(errorCode, errorMsg);
            }
        }
        //! [error]
        ...
        public virtual void historicalData(int reqId, Bar bar)
        {
            ...
            {
                case 1:
                    form1.HistoricalData(bar.Time, bar.Open, bar.High, bar.Low, bar.Close, bar.Volume, bar.WAP);
                    break;
                case 2:
                    form1.Historical5minData(bar);
                    break;
            }
        }
        //! [historicaldata]
        ...
        public void historicalDataUpdate(int reqId, Bar bar)
        {
            ...
            {
                case 1:
                    form1.HistoricalDataUpdate(bar);
                    break;
                case 2:
                    form1.Historical5minDataUpdate(bar);
                    break;
            }
        }
        //! [historicalDataUpdate]
